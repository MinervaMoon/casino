...
from .views import (
    PortadaView, TiendaListView, CartAddView, CartRemoveView, 
    ProcesarCompraView, RuletaView, TragaperrasView, 
    RavynGridView, BlackjackView, RegistroView, 
    cart_remove, cart_clear  
)
...
urlpatterns = [
    ...
    path('cart/remove/<int:paquete_id>/', cart_remove, name='cart_remove_funcion'),
